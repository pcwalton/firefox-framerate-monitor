...
FramerateWindow.prototype = {
    ...
    _onClearButtonClick: function() {
        this._getMonitorForWindowID(this._windowID).resetModel();
        this.view.redraw();
    },
    ...
    _getMonitorForWindowID: function(windowID) {
        ...
        if (!('_framerateMonitor' in window))
            window._framerateMonitor = new Monitor(this, window);
    ...
    _startMonitoringWindowWithID: function(windowID) {
        ...
        let monitor = this._getMonitorForWindowID(windowID);
        this.view.model = monitor.model;
